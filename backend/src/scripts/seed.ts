...
const disciplinas: SeedDisciplina[] = [
  {
    ...
    aulas: [
      ...
      {
        titulo: 'Frações de Forma Simples',
        descricao: 'Entenda numerador, denominador, frações equivalentes e operações básicas com exemplos do dia a dia.',
        modulo: 'Fundamentos',
        ordem: 4,
        duracao: 20,
        xpReward: 50,
      ...
      },
      {
        ...
        descricao: 'Como calcular descontos, acréscimos e juros simples usando porcentagens em situações reais.',
        modulo: 'Fundamentos',
        ordem: 5,
        duracao: 22,
        xpReward: 60,
      ...
      {
        titulo: 'Regra de Três Prática',
        descricao: 'Aplicações de regra de três direta e inversa em problemas do cotidiano.',
        modulo: 'Aplicações',
        ordem: 6,
        duracao: 24,
        xpReward: 70,
      ...
      },
      {
        ...
        descricao: 'Como isolar a incógnita, resolver equações simples e modelar problemas.',
        modulo: 'Álgebra',
        ordem: 7,
        duracao: 26,
        xpReward: 70,
  ...
  },
  {
    ...
    aulas: [
      ...
      },
      {
        ...
        descricao: 'Conceitos de corrente, tensão, resistência e circuitos simples com exemplos práticos.',
        modulo: 'Eletricidade',
        ordem: 4,
        duracao: 24,
        xpReward: 70,
  ...
  },
  {
    ...
    aulas: [
      ...
      },
      {
        ...
        descricao: 'O que é cidadania, direitos civis, políticos e sociais e como participar da sociedade.',
        modulo: 'Cidadania',
        ordem: 4,
        duracao: 22,
        xpReward: 60,
      ...
      {
        titulo: 'Brasil República: Da Proclamação à Atualidade',
        descricao: 'Panorama dos principais períodos da República brasileira e suas transformações políticas.',
        modulo: 'História do Brasil',
        ordem: 5,
        duracao: 28,
        xpReward: 80,
  ...
  },
  {
    ...
    aulas: [
      ...
      },
      {
        ...
        descricao: 'Por que falamos diferente? Variações regionais, sociais e situacionais da língua.',
        modulo: 'Sociolinguística',
        ordem: 4,
        duracao: 20,
        xpReward: 55,
        planoMinimo: 'gratis',
      ...
      {
        titulo: 'Gêneros Textuais no Cotidiano',
        descricao: 'Como reconhecer e produzir notícias, crônicas, e-mails, posts e outros gêneros do dia a dia.',
        modulo: 'Leitura',
        ordem: 5,
        duracao: 22,
        xpReward: 60,
  ...
  },
  {
    ...
    aulas: [
      ...
      },
      {
        ...
        descricao: 'O que é uma API REST, métodos HTTP, recursos e exemplos de uso no mundo real.',
      ...
      {
        titulo: 'Banco de Dados Essencial',
        descricao: 'Conceitos de tabela, registro, chave primária e introdução a consultas SQL.',
        modulo: 'Dados',
        ordem: 5,
        duracao: 28,
        xpReward: 80,
      ...
      },
      {
        ...
        descricao: 'Como estruturar uma página HTML e aplicar estilos com CSS para um visual moderno.',
        modulo: 'Desenvolvimento Web',
        ordem: 6,
        duracao: 26,
        xpReward: 70,
